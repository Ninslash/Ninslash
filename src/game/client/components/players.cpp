	...
	const CNetObj_PlayerInfo *pPlayerInfo)
{
	...
	*/
	...
	else if (IsModularWeapon(Player.m_Weapon) && GetPart(Player.m_Weapon, GROUP_PART1) == SW_BAZOOKA)
	{
		// melee attack effect
		if (pCustomPlayerInfo->m_MeleeTick < Player.m_AttackTick && !Paused)
		{
	...
	*/
	...
	if (IsModularWeapon(Player.m_Weapon) && GetPart(Player.m_Weapon, GROUP_PART1) == SW_BAZOOKA && !Paused)
	{
