...
CGameControllerBaseInf::CGameControllerBaseInf(class CGameContext *pGameServer) : IGameController(pGameServer)
{
	m_pGameType = "iDef";
...
bool CGameControllerBaseInf::OnEntity(int Index, vec2 Pos)
{
...
bool CGameControllerBaseInf::GetSpawnPos(int Team, vec2 *pOutPos)
{
...
void CGameControllerBaseInf::OnCharacterSpawn(CCharacter *pChr, bool RequestAI)
{
...
int CGameControllerBaseInf::OnCharacterDeath(class CCharacter *pVictim, class CPlayer *pKiller, int Weapon)
{
...
int CGameControllerBaseInf::ReactorsLeft()
{
...
void CGameControllerBaseInf::NextWave()
{
	m_WaveStartTick = 0;
	m_Bosses = 0;
	m_Wave++;
...
void CGameControllerBaseInf::Tick()
{
