#ifndef GAME_SERVER_GAMEMODES_BASE_INF_H
#define GAME_SERVER_GAMEMODES_BASE_INF_H
#include <game/server/gamecontroller.h>

#define MAX_ENEMIES 512

class CGameControllerBaseInf : public IGameController
{
private:
...
public:
	CGameControllerBaseInf(class CGameContext *pGameServer);
